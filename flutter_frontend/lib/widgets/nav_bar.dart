...
class NavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double curve = 20;
    final double space_from_wall = 4;
    ...
    return SizedBox(
      height: bar_height,
      child: Padding(
        padding: EdgeInsets.only(left: space_from_wall/2, right: space_from_wall/2, bottom: space_from_wall),
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: BottomNavigationBar(
                backgroundColor: Color(0xFF0C203F).withValues(alpha: 0.7),
                elevation: 0,
